...
## R scripts 
Nature_SupplementaryMaterials_html_default.Rmd: Rmarkdown R file for compiling Supplementary Material (https://github.com/kmander7/Paper-AFEX-NPP/blob/main/Nature_SupplementaryMaterials_html_default.html)
